...
from .models import SocialInformation, CustomUser as User
...
class SocialInformationTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.social = SocialInformation.objects.filter(owner=self.user.id).first()
    ...
    def test_invalid_update_social(self):
        ...
        """
        self.assertEqual(self.social.birth_date, datetime.date(1, 1, 1))
        data = {
            "owner": self.user.pk,
            "federal_unit": "AC",
            "city": "Rio Branco",
